    ...
    return (
        <div className='px-5 md:px-[150px]'>
            ...
            <div className='text-gray-500 md:ml-[200px]'>
                ...
                <p className='mt-9'>We cannot imagin a wedding without the opportunity to capture it on film, we would not be able to remember the growing up of children or the holidays if we did not haved picture.</p>
            </div>

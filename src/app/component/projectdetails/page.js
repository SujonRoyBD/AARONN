    ...
    return (
        <div className='px-5 md:px-[150px]'>
            ...
            <div className='text-gray-500 md:ml-[200px]'>
                ...
                <p>The fact that photography has different meanings to different people is one of the many components of it appeal. Photography is such an important parts of our life that it is now very difficult to imagine the world without it. </p>

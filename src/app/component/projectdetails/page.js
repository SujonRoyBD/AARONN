    ...
    return (
        <div className='px-5 md:px-[150px]'>
            ...
            <div className='text-gray-500 md:ml-[200px] mt-9'>
                ...
                <p className='mt-9'>And what help to achieve a good result? We will look at these issues and some of the possibilities of photography and explain that it is a combination of thought imagination, visual design, technical skills and organizational skills</p>
            </div>
            <Otherproject/>
        </div>
    );
